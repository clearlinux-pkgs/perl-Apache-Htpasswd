...
Requires: perl-Apache-Htpasswd-license
Requires: perl-Apache-Htpasswd-man
...
%package man
Summary: man components for the perl-Apache-Htpasswd package.
Group: Default

%description man
man components for the perl-Apache-Htpasswd package.
...
mkdir -p %{_topdir}/BUILD/Apache-Htpasswd-1.9/deblicense/
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/perl-Apache-Htpasswd
cp deblicense/copyright %{buildroot}/usr/share/doc/perl-Apache-Htpasswd/deblicense_copyright
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/Apache/Htpasswd.pm

%files license
%defattr(-,root,root,-)
/usr/share/doc/perl-Apache-Htpasswd/deblicense_copyright
